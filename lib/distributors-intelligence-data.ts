...
export interface BaseDistributor {
  ...
  provinces_territories_covered: string | null
...
export interface PremiumDistributor extends AdvanceDistributor {
  ...
  industrial_dealers?: string | null
  direct_sales_channels?: string | null
  service_centres?: string | null
...
export function getTableColumnsForModule(
  ...
  if (module.includes('Standard')) {
    columns.push(
      ...
      { key: 'headquarters_province', label: 'Headquarters / Province', section: section1 },
      { key: 'provinces_territories_covered', label: 'Provinces / Territories Covered', section: section1 },
    ...
    columns.push(
      ...
      { key: 'headquarters_province', label: 'Headquarters / Province', section: 'COMPANY INFORMATION' },
      { key: 'provinces_territories_covered', label: 'Provinces / Territories Covered', section: 'COMPANY INFORMATION' },
      ...
      { key: 'core_product_categories', label: 'Core Product Categories (Compressor Types)', section: 'PRODUCT PORTFOLIO' },
    ...
    columns.push(
      ...
      { key: 'industrial_dealers', label: 'Industrial Dealers / Resellers', section: 'DISTRIBUTION CHANNELS' },
      { key: 'direct_sales_channels', label: 'Direct Sales Channels', section: 'DISTRIBUTION CHANNELS' },
      { key: 'service_centres', label: 'Service Centres / After-Sales', section: 'DISTRIBUTION CHANNELS' },
      { key: 'ecommerce_platforms', label: 'E-commerce / Online Platforms', section: 'DISTRIBUTION CHANNELS' },
      ...
      { key: 'provinces_served', label: 'Provinces / Territories Served', section: 'REGIONAL & OPERATIONAL COVERAGE' },
      ...
      { key: 'delivery_storage', label: 'Delivery / Storage Capabilities', section: 'REGIONAL & OPERATIONAL COVERAGE' },
      // CMI Insights (2 fields)
      { key: 'competitive_benchmarking', label: 'Competitive Benchmarking', section: 'CMI INSIGHTS' },
      { key: 'additional_comments', label: 'Additional Comments by CMI Team', section: 'CMI INSIGHTS' }
    )
  }
