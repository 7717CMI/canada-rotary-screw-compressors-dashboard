          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                {dist.headquarters_province && (
                  <div>
                    <label className="text-xs font-medium text-black uppercase">Headquarters / Province</label>
                    <p className="text-sm text-black mt-1">{formatDistributorField(dist.headquarters_province)}</p>
                  </div>
                )}

                {dist.provinces_territories_covered && (
                  <div>
                    <label className="text-xs font-medium text-black uppercase">Provinces / Territories Covered</label>
                    <p className="text-sm text-black mt-1">{formatDistributorField(dist.provinces_territories_covered)}</p>
                  </div>
                )}
            ...
            {module.includes('Premium') && (
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {dist.industrial_dealers && (
                    <div>
                      <label className="text-xs font-medium text-black uppercase">Industrial Dealers</label>
                      <p className="text-sm text-black mt-1">{formatDistributorField(dist.industrial_dealers)}</p>
                    </div>
                  )}

                  {dist.direct_sales_channels && (
                    <div>
                      <label className="text-xs font-medium text-black uppercase">Direct Sales Channels</label>
                      <p className="text-sm text-black mt-1">{formatDistributorField(dist.direct_sales_channels)}</p>
                    </div>
                  )}

                  {dist.service_centres && (
                    <div>
                      <label className="text-xs font-medium text-black uppercase">Service Centres</label>
                      <p className="text-sm text-black mt-1">{formatDistributorField(dist.service_centres)}</p>
                    </div>
                  )}
            ...
            {module.includes('Premium') && (
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {dist.provinces_served && (
                    <div>
                      <label className="text-xs font-medium text-black uppercase">Provinces Served</label>
                      <p className="text-sm text-black mt-1">{formatDistributorField(dist.provinces_served)}</p>
                    </div>
                  )}
            ...
            <tr>
              {visibleColumns.map((column) => {
                const isWideColumn = ['core_product_categories', 'key_brands_represented', 
                                     'industrial_dealers', 'competitive_benchmarking'].includes(column)
