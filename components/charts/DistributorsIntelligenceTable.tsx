          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div>
                  <label className="text-xs font-medium text-black uppercase">3. Headquarters / Province</label>
                  <p className="text-sm text-black mt-1">{formatDistributorField(dist.headquarters_province)}</p>
                </div>

                <div>
                  <label className="text-xs font-medium text-black uppercase">4. Provinces / Territories Covered</label>
            ...
            {module.includes('Premium') && (
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div>
                    <label className="text-xs font-medium text-black uppercase">21. Industrial Dealers</label>
                    <p className="text-sm text-black mt-1">{formatDistributorField(dist.industrial_dealers)}</p>
                  </div>

                  <div>
                    <label className="text-xs font-medium text-black uppercase">22. Direct Sales Channels</label>
                    <p className="text-sm text-black mt-1">{formatDistributorField(dist.direct_sales_channels)}</p>
                  </div>

                  <div>
                    <label className="text-xs font-medium text-black uppercase">23. Service Centres</label>
            ...
            {module.includes('Premium') && (
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div>
                    <label className="text-xs font-medium text-black uppercase">27. Provinces Served</label>
